...
const SUPABASE_URL = process.env.SUPABASE_URL || "https://tahbjwbmigoodfrfjpri.supabase.co";
const SUPABASE_ANON_KEY = process.env.SUPABASE_ANON_KEY || "sb_publishable_85PWR75Vq5WcSWvgos6pmg_4JwG0_iM";
