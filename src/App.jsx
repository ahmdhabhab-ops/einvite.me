...
const SUPABASE_URL = "https://tahbjwbmigoodfrfjpri.supabase.co"; // <-- replace with your real Project URL
const SUPABASE_ANON_KEY = "sb_publishable_85PWR75Vq5WcSWvgos6pmg_4JwG0_iM";// <-- replace with your real anon public key
